...
| components.dicom.receiver.image | string | `"ghcr.io/firemetrics/dicom_receiver:e849f807"` | The image used for the DICOM receiver pods. |
...
| components.fuego.image | string | `"ghcr.io/firemetrics/fuego:e849f807"` | The image used for the Fuego pods. |
...
| components.panel.image | string | `"ghcr.io/firemetrics/fmx-panel:v1.2.2"` | The image used for the Panel pods. |
...
| spiloImage | string | `"ghcr.io/firemetrics/spilo17:4.0-p2-e849f807"` | The image used for the Spilo Postgres cluster pods. |
