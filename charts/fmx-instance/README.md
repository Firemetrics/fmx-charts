...
![Version: 1.15.1](https://img.shields.io/badge/Version-1.15.1-informational?style=flat-square)
...
| firemetricsVersion | string | `"v0.11.0"` | The version tag for core Firemetrics images (fuego, dicom_receiver, spilo). |
