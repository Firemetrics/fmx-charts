...
| components.panel.image | string | `"ghcr.io/firemetrics/fmx-panel:v1.4.0"` | The image used for the Panel pods. |
...
| firemetricsVersion | string | `"v0.8.6"` | The version tag for core Firemetrics images (fuego, dicom_receiver, spilo). |
