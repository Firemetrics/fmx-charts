...
| components.panel.image | string | `"ghcr.io/firemetrics/fmx-panel:v1.9.0"` | The image used for the Panel pods. |
...
| components.panel.mcpUrl | string | `"https://mcp.firemetrics.ai/mcp"` | The MCP server URL for the Panel AI assistant. |
...
| firemetricsVersion | string | `"v0.11.1"` | The version tag for core Firemetrics images (fuego, dicom_receiver, spilo). |
